...
void Bigtree()
{
    ...
    circle(0.04f, 0.7f, 0.092f, 0.0f, 0.75f, 0.0f);
    glEnd();
    circle(0.02f, 0.66f, 0.062f, 0.0f, 0.4f, 0.0f);
    glEnd();
    circle(0.04f, 0.68f, 0.09f, 0.0f, 0.8f, 0.0f);
    ...
    circle(0.04f, 0.52f, 0.092f, 0.0f, 0.75f, 0.0f);
    glEnd();
    circle(0.03f, 0.55f, 0.06f, 0.0f, 0.4f, 0.0f);
    glEnd();
    circle(0.04f, 0.545f, 0.08f, 0.0f, 0.8f, 0.0f);
    glEnd();

    circle(0.03f, 0.55f, 0.11f, 0.0f, 0.4f, 0.0f);
    glEnd();
    circle(0.03f, 0.65f, 0.13f, 0.0f, 0.4f, 0.0f);
    glEnd();
    circle(0.03f, 0.6f, 0.12f, 0.0f, 0.4f, 0.0f);
    glEnd();

    circle(0.05f, 0.55f, 0.145f, 0.0f, 0.8f, 0.0f);
    glEnd();
    circle(0.05f, 0.62f, 0.155f, 0.0f, 0.8f, 0.0f);
    glEnd();

    circle(0.045f, 0.57f, 0.18f, 0.0f, 0.8f, 0.0f);
    glEnd();
    circle(0.045f, 0.655f, 0.19f, 0.0f, 0.8f, 0.0f);
    glEnd();
    circle(0.038f, 0.68f, 0.14f, 0.0f, 0.8f, 0.0f);
    glEnd();

    circle(0.05f, 0.56f, 0.21f, 0.0f, 0.85f, 0.0f);
    glEnd();
    circle(0.055f, 0.63f, 0.24f, 0.0f, 0.85f, 0.0f);
    glEnd();
    circle(0.045f, 0.58f, 0.24f, 0.0f, 0.85f, 0.0f);
    glEnd();
    circle(0.05f, 0.65f, 0.2f, 0.0f, 0.85f, 0.0f);
    glEnd();
...
void BigtreeS()
{
    ...
    circle(0.05f, 0.55f, 0.145f, 0.5f, 0.85f, 0.6f);
    glEnd();
    circle(0.05f, 0.62f, 0.155f, 0.5f, 0.85f, 0.6f);
    glEnd();

    circle(0.045f, 0.57f, 0.18f, 0.5f, 0.85f, 0.6f);
    glEnd();
    circle(0.045f, 0.655f, 0.19f, 0.5f, 0.85f, 0.6f);
    glEnd();
    circle(0.038f, 0.68f, 0.14f, 0.5f, 0.85f, 0.6f);
    glEnd();

    circle(0.05f, 0.56f, 0.21f, 0.7f, 0.95f, 0.7f);
    glEnd();
    circle(0.055f, 0.63f, 0.24f, 0.7f, 0.95f, 0.7f);
    glEnd();
    circle(0.045f, 0.58f, 0.24f, 0.7f, 0.95f, 0.7f);
    glEnd();
    circle(0.05f, 0.65f, 0.2f, 0.7f, 0.95f, 0.7f);
    glEnd();
...
void updateVehicals2(int value)
{
